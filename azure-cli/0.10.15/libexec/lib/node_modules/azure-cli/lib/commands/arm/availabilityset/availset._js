...
exports.init = function (cli) {
  ...
  availset.command('create [resource-group] [name] [location] [tags]')
    ...
    .option('-a, --platform-update-domain-count <platformUpdateDomainCount>', $('Set the platform-update-domain-count value.'))
    .option('-b, --platform-fault-domain-count <platformFaultDomainCount>', $('Set the platform-fault-domain-count value.'))
