...
__.extend(TrafficManager.prototype, {
  /**
   * Traffic Manager Profile methods
   */
  createProfile: function (profileName, options, _) {
    var self = this;
    ...
    self._showProfile(profileName, tmProfile, tmDefinition);
  },

  setProfile: function (profileName, options, _) {
    var self = this;
    var tmProfile = self.getProfile(profileName, _);
    if (!tmProfile) {
  ...
  showProfile: function (profileName, options, _) {
    var self = this;
    var tmProfile = self.getProfile(profileName, _);
    var tmDefinition = self.getDefinition(profileName, _);
    self._showProfile(profileName, tmProfile, tmDefinition);
  ...
  deleteProfile: function (profileName, options, _) {
    var self = this;
    var tmProfile = self.getProfile(profileName, _);
    if (!tmProfile) {
  ...
  enableProfile: function (profileName, options, _) {
    var self = this;
    var tmProfile = self.getProfile(profileName, _);
    if (!tmProfile) {
      ...
      self.updateProfile(profileName, 'Enabled', definitionVersionNumber, _);
      self.showProfile(profileName, options, _);
    }
  },

  disableProfile: function (profileName, options, _) {
    var self = this;
    var tmProfile = self.getProfile(profileName, _);
    if (!tmProfile) {
      if (self.output.format().json) {
      ...
      var definitionVersionNumber = tmProfile.profile.definitions[0].version;
      self.updateProfile(profileName, 'Disabled', definitionVersionNumber, _);
      self.showProfile(profileName, options, _);
    }
  },
  ...
  updateProfile: function (profileName, profileStatus, definitionVersionNumber, _) {
    var self = this;
  ...
  /**
   * Traffic Manager Endpoint methods
   */
