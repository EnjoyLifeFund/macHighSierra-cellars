...
__.extend(WebsitesClient.prototype, {
  ...
  createSite: function (subscription, webspace, site, _) {
    ...
    try {
      ...
      //We need to update our webspace cache to ensure that the webspace in which the 
      //above site was created is present in the cache.
      self.getSpaces({subscription: subscription}, _);
      return result;
    } catch (err) {
