 ...
 *
 */
function DataLakeStoreAccountManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  DataLakeStoreAccountManagementClient['super_'].call(this, credentials, options);
...
util.inherits(DataLakeStoreAccountManagementClient, ServiceClient);

module.exports = DataLakeStoreAccountManagementClient;
