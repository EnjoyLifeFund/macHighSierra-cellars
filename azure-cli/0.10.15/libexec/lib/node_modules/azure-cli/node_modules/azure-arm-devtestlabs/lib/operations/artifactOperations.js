 ...
 */
function ArtifactOperations(client) {
  this.client = client;
}
 ...
 */
ArtifactOperations.prototype.list = function (resourceGroupName, labName, artifactSourceName, options, callback) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['ResponseWithContinuationArtifact']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ArtifactOperations.prototype.getResource = function (resourceGroupName, labName, artifactSourceName, name, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['Artifact']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        var deserializationError = new Error(util.format('Error "%s" occurred in deserializing the responseBody - "%s"', error, responseBody));
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ArtifactOperations.prototype.generateArmTemplate = function (resourceGroupName, labName, artifactSourceName, name, generateArmTemplateRequest, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  try {
    if (generateArmTemplateRequest !== null && generateArmTemplateRequest !== undefined) {
      var requestModelMapper = new client.models['GenerateArmTemplateRequest']().mapper();
    ...
    var serializationError = new Error(util.format('Error "%s" occurred in serializing the ' + 
        'payload - "%s"', error.message, util.inspect(generateArmTemplateRequest, {depth: null})));
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['ArmTemplateInfo']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        var deserializationError = new Error(util.format('Error "%s" occurred in deserializing the responseBody - "%s"', error, responseBody));
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ArtifactOperations.prototype.listNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
