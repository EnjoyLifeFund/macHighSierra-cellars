 ...
 */
function ArtifactSourceOperations(client) {
  this.client = client;
}
 ...
 */
ArtifactSourceOperations.prototype.list = function (resourceGroupName, labName, options, callback) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['ResponseWithContinuationArtifactSource']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ArtifactSourceOperations.prototype.getResource = function (resourceGroupName, labName, name, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['ArtifactSource']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        var deserializationError = new Error(util.format('Error "%s" occurred in deserializing the responseBody - "%s"', error, responseBody));
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ArtifactSourceOperations.prototype.createOrUpdateResource = function (resourceGroupName, labName, name, artifactSource, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  try {
    if (artifactSource !== null && artifactSource !== undefined) {
      var requestModelMapper = new client.models['ArtifactSource']().mapper();
      requestModel = client.serialize(requestModelMapper, artifactSource, 'artifactSource');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    var serializationError = new Error(util.format('Error "%s" occurred in serializing the ' + 
        'payload - "%s"', error.message, util.inspect(artifactSource, {depth: null})));
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ArtifactSourceOperations.prototype.deleteResource = function (resourceGroupName, labName, name, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ArtifactSourceOperations.prototype.patchResource = function (resourceGroupName, labName, name, artifactSource, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ArtifactSourceOperations.prototype.listNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
