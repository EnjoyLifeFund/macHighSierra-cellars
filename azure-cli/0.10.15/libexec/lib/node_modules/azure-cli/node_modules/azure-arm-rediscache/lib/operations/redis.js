 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Redis.prototype.importMethod = function (resourceGroupName, name, parameters, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginImportMethod(resourceGroupName, name, parameters, options, function (err, parsedResult, httpRequest, response){
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Redis.prototype.beginImportMethod = function (resourceGroupName, name, parameters, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Redis.prototype.exportMethod = function (resourceGroupName, name, parameters, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginExportMethod(resourceGroupName, name, parameters, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Redis.prototype.beginExportMethod = function (resourceGroupName, name, parameters, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
