 ...
 * Initializes a new instance of the ApplicationManifests class.
 * @constructor
 *
 * @param {ServiceFabricClient} client Reference to the service client.
 */
function ApplicationManifests(client) {
  this.client = client;
}
 ...
 */
ApplicationManifests.prototype.get = function (applicationTypeName, applicationTypeVersion, options, callback) {
...
module.exports = ApplicationManifests;
