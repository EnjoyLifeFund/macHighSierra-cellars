 ...
 * Initializes a new instance of the PartitionHealths class.
 * @constructor
 *
 * @param {ServiceFabricClient} client Reference to the service client.
 */
function PartitionHealths(client) {
  this.client = client;
}
 ...
 */
PartitionHealths.prototype.get = function (partitionId, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
PartitionHealths.prototype.send = function (partitionId, partitionHealthReport, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
...
module.exports = PartitionHealths;
