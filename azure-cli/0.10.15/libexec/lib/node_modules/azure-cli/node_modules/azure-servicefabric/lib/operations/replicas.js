 ...
 * Initializes a new instance of the Replicas class.
 * @constructor
 *
 ...
 */
Replicas.prototype.list = function (partitionId, options, callback) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['ReplicaList']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Replicas.prototype.get = function (partitionId, replicaId, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
