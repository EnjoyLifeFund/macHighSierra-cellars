 ...
 * Initializes a new instance of the ServiceGroupFromTemplates class.
 * @constructor
 *
 * @param {ServiceFabricClient} client Reference to the service client.
 */
function ServiceGroupFromTemplates(client) {
  this.client = client;
}
 ...
 */
ServiceGroupFromTemplates.prototype.create = function (applicationName, serviceDescriptionTemplate, options, callback) {
...
module.exports = ServiceGroupFromTemplates;
