...
enum opt_code
{
  ...
  OPT_mpure_code = 1211,                     /* -mpure-code */
  ...
  OPT_o = 1239,                              /* -o */
  OPT_p = 1240,                              /* -p */
  OPT_pass_exit_codes = 1241,                /* -pass-exit-codes */
  /* OPT_pedantic = 1242, */                 /* -pedantic */
  OPT_pedantic_errors = 1243,                /* -pedantic-errors */
  OPT_pg = 1244,                             /* -pg */
  OPT_pie = 1245,                            /* -pie */
  OPT_pipe = 1246,                           /* -pipe */
