...
enum opt_code
{
  ...
  /* OPT_mfused_madd = 1283, */              /* -mfused-madd */
  OPT_mfxsr = 1284,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1285,             /* -mgeneral-regs-only */
  OPT_mhard_float = 1286,                    /* -mhard-float */
  OPT_mhle = 1287,                           /* -mhle */
  OPT_miamcu = 1288,                         /* -miamcu */
  OPT_mieee_fp = 1289,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1290,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1291,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1292,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1293, */            /* -mintel-syntax */
  OPT_mkernel = 1294,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1295,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1296,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1297,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1298,                /* -mlong-double-80 */
  OPT_mlwp = 1299,                           /* -mlwp */
  OPT_mlzcnt = 1300,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1301,           /* -mmacosx-version-min= */
  OPT_mmemcpy_strategy_ = 1302,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1303,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1304,                  /* -mmitigate-rop */
  OPT_mmmx = 1305,                           /* -mmmx */
  OPT_mmovbe = 1306,                         /* -mmovbe */
  OPT_mmpx = 1307,                           /* -mmpx */
  OPT_mms_bitfields = 1308,                  /* -mms-bitfields */
  OPT_mmwaitx = 1309,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1310,            /* -mno-align-stringops */
  OPT_mno_default = 1311,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1312,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1313,                  /* -mno-push-args */
  OPT_mno_red_zone = 1314,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1315,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1316,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1317,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1318,                 /* -mone-byte-bool */
  OPT_mpc32 = 1319,                          /* -mpc32 */
  OPT_mpc64 = 1320,                          /* -mpc64 */
  OPT_mpc80 = 1321,                          /* -mpc80 */
  OPT_mpclmul = 1322,                        /* -mpclmul */
  OPT_mpcommit = 1323,                       /* -mpcommit */
  OPT_mpku = 1324,                           /* -mpku */
  OPT_mpopcnt = 1325,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1326,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1327,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1328,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1329,                        /* -mprfchw */
  OPT_mpush_args = 1330,                     /* -mpush-args */
  OPT_mrdpid = 1331,                         /* -mrdpid */
  OPT_mrdrnd = 1332,                         /* -mrdrnd */
  OPT_mrdseed = 1333,                        /* -mrdseed */
  OPT_mrecip = 1334,                         /* -mrecip */
  OPT_mrecip_ = 1335,                        /* -mrecip= */
  OPT_mrecord_mcount = 1336,                 /* -mrecord-mcount */
  OPT_mred_zone = 1337,                      /* -mred-zone */
  OPT_mregparm_ = 1338,                      /* -mregparm= */
  OPT_mrtd = 1339,                           /* -mrtd */
  OPT_mrtm = 1340,                           /* -mrtm */
  OPT_msahf = 1341,                          /* -msahf */
  OPT_msgx = 1342,                           /* -msgx */
  OPT_msha = 1343,                           /* -msha */
  OPT_mskip_rax_setup = 1344,                /* -mskip-rax-setup */
  OPT_msoft_float = 1345,                    /* -msoft-float */
  OPT_msse = 1346,                           /* -msse */
  OPT_msse2 = 1347,                          /* -msse2 */
  OPT_msse2avx = 1348,                       /* -msse2avx */
  OPT_msse3 = 1349,                          /* -msse3 */
  OPT_msse4 = 1350,                          /* -msse4 */
  OPT_msse4_1 = 1351,                        /* -msse4.1 */
  OPT_msse4_2 = 1352,                        /* -msse4.2 */
  OPT_msse4a = 1353,                         /* -msse4a */
  /* OPT_msse5 = 1354, */                    /* -msse5 */
  OPT_msseregparm = 1355,                    /* -msseregparm */
  OPT_mssse3 = 1356,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1357,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1358,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1359,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1360,            /* -mstringop-strategy= */
  OPT_mstv = 1361,                           /* -mstv */
  OPT_mtarget_linker = 1362,                 /* -mtarget-linker */
  OPT_mtbm = 1363,                           /* -mtbm */
  OPT_mtls_dialect_ = 1364,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1365,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1366,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1367,                         /* -mtune= */
  /* OPT_multi_module = 1368, */             /* -multi_module */
  /* OPT_multiply_defined = 1369, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1370, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1371,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1372,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1373,                    /* -mvzeroupper */
  OPT_mx32 = 1374,                           /* -mx32 */
  OPT_mxop = 1375,                           /* -mxop */
  OPT_mxsave = 1376,                         /* -mxsave */
  OPT_mxsavec = 1377,                        /* -mxsavec */
  OPT_mxsaveopt = 1378,                      /* -mxsaveopt */
  OPT_mxsaves = 1379,                        /* -mxsaves */
  OPT_n = 1380,                              /* -n */
  OPT_no_canonical_prefixes = 1381,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1382,              /* -no-integrated-cpp */
  OPT_no_pie = 1383,                         /* -no-pie */
  /* OPT_no_dead_strip_inits_and_terms = 1384, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1385,                          /* -nocpp */
  OPT_nodefaultlibs = 1386,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1387,                /* -nofixprebinding */
  OPT_nomultidefs = 1388,                    /* -nomultidefs */
  OPT_noprebind = 1389,                      /* -noprebind */
  OPT_noseglinkedit = 1390,                  /* -noseglinkedit */
  OPT_nostartfiles = 1391,                   /* -nostartfiles */
  OPT_nostdinc = 1392,                       /* -nostdinc */
  OPT_nostdinc__ = 1393,                     /* -nostdinc++ */
  OPT_nostdlib = 1394,                       /* -nostdlib */
  OPT_o = 1395,                              /* -o */
  OPT_object = 1396,                         /* -object */
  OPT_p = 1397,                              /* -p */
  OPT_pagezero_size = 1398,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1399,                /* -pass-exit-codes */
  /* OPT_pedantic = 1400, */                 /* -pedantic */
  OPT_pedantic_errors = 1401,                /* -pedantic-errors */
  OPT_pg = 1402,                             /* -pg */
  OPT_pie = 1403,                            /* -pie */
  OPT_pipe = 1404,                           /* -pipe */
  OPT_prebind = 1405,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1406,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1407,                        /* -preload */
  OPT_print_file_name_ = 1408,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1409,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1410,          /* -print-multi-directory */
  OPT_print_multi_lib = 1411,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1412,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1413,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1414,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1415,               /* -print-prog-name= */
  OPT_print_search_dirs = 1416,              /* -print-search-dirs */
  OPT_print_sysroot = 1417,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1418,   /* -print-sysroot-headers-suffix */
  OPT_private_bundle = 1419,                 /* -private_bundle */
  OPT_pthread = 1420,                        /* -pthread */
  OPT_quiet = 1421,                          /* -quiet */
  OPT_r = 1422,                              /* -r */
  OPT_rdynamic = 1423,                       /* -rdynamic */
  OPT_read_only_relocs = 1424,               /* -read_only_relocs */
  OPT_remap = 1425,                          /* -remap */
  OPT_s = 1426,                              /* -s */
  OPT_save_temps = 1427,                     /* -save-temps */
  OPT_save_temps_ = 1428,                    /* -save-temps= */
  OPT_sectalign = 1429,                      /* -sectalign */
  OPT_sectcreate = 1430,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1431,              /* -sectobjectsymbols */
  OPT_sectorder = 1432,                      /* -sectorder */
  OPT_seg1addr = 1433,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1434, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1435, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1436, */                  /* -segaddr */
  OPT_segcreate = 1437,                      /* -segcreate */
  OPT_seglinkedit = 1438,                    /* -seglinkedit */
  OPT_segprot = 1439,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1440, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1441, */     /* -segs_read_write_addr */
  OPT_shared = 1442,                         /* -shared */
  OPT_shared_libgcc = 1443,                  /* -shared-libgcc */
  /* OPT_single_module = 1444, */            /* -single_module */
  /* OPT_specs = 1445, */                    /* -specs */
  OPT_specs_ = 1446,                         /* -specs= */
  OPT_static = 1447,                         /* -static */
  OPT_static_libasan = 1448,                 /* -static-libasan */
  OPT_static_libgcc = 1449,                  /* -static-libgcc */
  OPT_static_libgfortran = 1450,             /* -static-libgfortran */
  OPT_static_libgo = 1451,                   /* -static-libgo */
  OPT_static_liblsan = 1452,                 /* -static-liblsan */
  OPT_static_libmpx = 1453,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1454,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1455,               /* -static-libstdc++ */
  OPT_static_libtsan = 1456,                 /* -static-libtsan */
  OPT_static_libubsan = 1457,                /* -static-libubsan */
  /* OPT_std_c__03 = 1458, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1459, */                /* -std=c++0x */
  OPT_std_c__11 = 1460,                      /* -std=c++11 */
  OPT_std_c__14 = 1461,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1462, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1463, */                /* -std=c++1y */
  OPT_std_c__1z = 1464,                      /* -std=c++1z */
  OPT_std_c__98 = 1465,                      /* -std=c++98 */
  OPT_std_c11 = 1466,                        /* -std=c11 */
  /* OPT_std_c1x = 1467, */                  /* -std=c1x */
  /* OPT_std_c89 = 1468, */                  /* -std=c89 */
  OPT_std_c90 = 1469,                        /* -std=c90 */
  OPT_std_c99 = 1470,                        /* -std=c99 */
  /* OPT_std_c9x = 1471, */                  /* -std=c9x */
  OPT_std_f2003 = 1472,                      /* -std=f2003 */
  OPT_std_f2008 = 1473,                      /* -std=f2008 */
  OPT_std_f2008ts = 1474,                    /* -std=f2008ts */
  OPT_std_f95 = 1475,                        /* -std=f95 */
  OPT_std_gnu = 1476,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1477, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1478, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1479,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1480,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1481, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1482, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1483,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1484,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1485,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1486, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1487, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1488,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1489,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1490, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1491, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1492,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1493, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1494, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1495, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1496,                     /* -std=legacy */
  OPT_sub_library = 1497,                    /* -sub_library */
  OPT_sub_umbrella = 1498,                   /* -sub_umbrella */
  OPT_symbolic = 1499,                       /* -symbolic */
  OPT_t = 1500,                              /* -t */
  OPT_time = 1501,                           /* -time */
  OPT_time_ = 1502,                          /* -time= */
  OPT_traditional = 1503,                    /* -traditional */
  OPT_traditional_cpp = 1504,                /* -traditional-cpp */
  OPT_trigraphs = 1505,                      /* -trigraphs */
  OPT_twolevel_namespace = 1506,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1507,       /* -twolevel_namespace_hints */
  OPT_u = 1508,                              /* -u */
  /* OPT_umbrella = 1509, */                 /* -umbrella */
  OPT_undef = 1510,                          /* -undef */
  OPT_undefined = 1511,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1512, */  /* -unexported_symbols_list */
  OPT_v = 1513,                              /* -v */
  OPT_version = 1514,                        /* -version */
  OPT_w = 1515,                              /* -w */
  /* OPT_weak_reference_mismatches = 1516, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1517,                    /* -whatsloaded */
  OPT_whyload = 1518,                        /* -whyload */
  OPT_wrapper = 1519,                        /* -wrapper */
  OPT_x = 1520,                              /* -x */
  OPT_y = 1521,                              /* -y */
  OPT_z = 1522,                              /* -z */
  N_OPTS,
