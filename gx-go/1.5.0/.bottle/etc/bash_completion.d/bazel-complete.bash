...
BAZEL_COMMAND_LIST="analyze-profile build canonicalize-flags clean coverage dump fetch help info license mobile-install query run shutdown test version"
BAZEL_INFO_KEYS="
workspace
install_base
output_base
