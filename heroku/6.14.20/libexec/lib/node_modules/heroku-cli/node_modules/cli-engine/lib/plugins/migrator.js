...
exports.default = class {
  ...
  constructor(config) {
    let out = new _output2.default(config);
    let cache = new _cache2.default(out);
    this.userPlugins = new _user2.default({ out, config: out.config, cache });
    this.linkedPlugins = new _linked2.default({ out, config: out.config, cache });
    this.out = out;
