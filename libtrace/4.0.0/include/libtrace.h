...
typedef struct libtrace_packet_t {
	...
	int error; /**< The error status of pread_packet */
        uint64_t internalid;            /** Internal indentifier for the pkt */
        void *srcbucket;
} libtrace_packet_t;
...
/* To add a new stat field update this list, and the relevent places in
...
#undef X
	...
	LT_BITFIELD64 reserved1: 26; /**< Bits reserved for future fields */
	...
	/** The total number of good packets which have been recevied. Including
 ...
 * combined total.
 * Where possible these are retrived atomically, however this behaviour depends
 ...
 *
 * @param trace The input trace to examine.
 * @param t An optional thread to received stats for or NULL to retrive stats
