...
#define DEFAULT_MYSQL_HOME "/usr/local/Cellar/mariadb/10.2.9"
#define SHAREDIR "/usr/local/Cellar/mariadb/10.2.9/share/mysql"
#define DEFAULT_BASEDIR "/usr/local/Cellar/mariadb/10.2.9"
#define MYSQL_DATADIR "/usr/local/var/mysql"
#define DEFAULT_CHARSET_HOME "/usr/local/Cellar/mariadb/10.2.9"
#define PLUGINDIR "/usr/local/Cellar/mariadb/10.2.9/lib/plugin"
