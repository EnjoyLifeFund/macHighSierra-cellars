...
{ "ER_KEY_CREATE_DURING_ALTER", 4065, "MyRocks failed creating new key definitions during alter." },
{ "ER_SK_POPULATE_DURING_ALTER", 4066, "MyRocks failed populating secondary key during alter." },
{ "ER_CF_DIFFERENT", 4067, "Column family (\'%s\') flag (%d) is different from an existing flag (%d). Assign a new CF flag, or do not change existing CF flag." },
{ "ER_RDB_STATUS_GENERAL", 4068, "Status error %d received from RocksDB: %s" },
{ "ER_RDB_STATUS_MSG", 4069, "%s, Status error %d received from RocksDB: %s" },
{ "ER_NET_OK_PACKET_TOO_LARGE", 4070, "OK packet too large" },
{ "ER_RDB_TTL_UNSUPPORTED", 4071, "TTL support is currently disabled when table has secondary indexes or hidden PK." },
{ "ER_RDB_TTL_COL_FORMAT", 4072, "TTL column (%s) in MyRocks must be an unsigned non-null 64-bit integer, exist inside the table, and have an accompanying ttl duration." },
{ "ER_RDB_TTL_DURATION_FORMAT", 4073, "TTL duration (%s) in MyRocks must be an unsigned non-null 64-bit integer." },
{ "ER_PER_INDEX_CF_DEPRECATED", 4074, "The per-index column family option has been deprecated" },
{ "ER_SUM_FUNC_WITH_WINDOW_FUNC_AS_ARG", 4075, "Window functions can not be used as arguments to group functions." },
