...
#define DEFAULT_MYSQL_HOME "/usr/local/Cellar/mysql/5.7.19"
#define SHAREDIR "/usr/local/Cellar/mysql/5.7.19/share/mysql"
#define DEFAULT_BASEDIR "/usr/local/Cellar/mysql/5.7.19"
#define MYSQL_DATADIR "/usr/local/var/mysql"
#define MYSQL_KEYRINGDIR "/usr/local/Cellar/mysql/5.7.19/keyring"
#define DEFAULT_CHARSET_HOME "/usr/local/Cellar/mysql/5.7.19"
#define PLUGINDIR "/usr/local/Cellar/mysql/5.7.19/lib/plugin"
