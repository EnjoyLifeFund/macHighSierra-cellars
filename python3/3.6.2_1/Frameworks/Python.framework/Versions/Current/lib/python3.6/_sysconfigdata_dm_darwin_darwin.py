...
build_time_vars = {'ABIFLAGS': 'dm',
 ...
 'BINLIBDEST': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib/python3.6',
 'BLDLIBRARY': '',
 ...
 'CC': 'mpicc',
 'CCSHARED': '',
 'CFLAGS': '-Wsign-compare -fno-common -dynamic '
           ...
           '-msse -flto -maes -march=native  -march=native',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIG_ARGS': "'--enable-ipv6' '--enable-optimizations' "
                ...
                "'--datadir=/usr/local/Cellar/python3/3.6.2_1/share' "
                "'--enable-framework=/usr/local/Cellar/python3/3.6.2_1/Frameworks' "
                "'--prefix=/usr/local/Cellar/python3/3.6.2_1' 'CC=mpicc' "
                "'CFLAGS=-fomit-frame-pointer -funroll-loops  -ffast-math "
                '-Ofast -fno-signed-zeros -ffp-contract=fast -mmmx -msse -flto '
                "-maes -march=native  -march=native' "
 ...
 'CONFINCLUDEDIR': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/include',
 'CONFINCLUDEPY': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/include/python3.6dm',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/Users/dojo/work/zspecial/python3.62mac/coverage.info',
 'COVERAGE_REPORT': '/Users/dojo/work/zspecial/python3.62mac/lcov-report',
 ...
 'CXX': 'g++-7',
 'DESTDIRS': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6 '
             '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib '
             '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib/python3.6 '
             '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib/python3.6/lib-dynload',
 'DESTLIB': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib/python3.6',
 'DESTPATH': '',
 'DESTSHARED': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib/python3.6/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/include '
                   '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/include '
                   '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/include/python3.6dm '
                   '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/include/python3.6dm',
 'INCLUDEDIR': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/include',
 'INCLUDEPY': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/include/python3.6dm',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++-7 -bundle -undefined dynamic_lookup',
 'LDFLAGS': '-L/usr/local/opt/lapack/lib -L/usr/local/opt/openblas/lib '
            '-L/usr/local/opt/llvm/lib -L/usr/local/opt/sqlite/lib '
            '-L/usr/local/opt/readline/lib -L/usr/local/opt/openssl@1.1/lib',
 'LDLAST': '',
 ...
 'LDVERSION': '3.6dm',
 'LIBC': '',
 'LIBDEST': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib/python3.6',
 'LIBDIR': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib/pkgconfig',
 'LIBPL': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib/python3.6/config-3.6dm-darwin',
 ...
 'MACHDEPPATH': ':',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib/python3.6',
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-Wsign-compare -fno-common -dynamic '
              '-DDYNAMIC_ANNOTATIONS_ENABLED=1 -g -Ofast -Wall '
              '-Wstrict-prototypes  -fomit-frame-pointer -funroll-loops  '
              '-ffast-math -Ofast -fno-signed-zeros -ffp-contract=fast -mmmx '
              '-msse -flto -maes -march=native  -march=native',
 'PY_CFLAGS_NODIST': '-fomit-frame-pointer -funroll-loops  -ffast-math -Ofast '
                     '-fno-signed-zeros -ffp-contract=fast -mmmx -msse -flto '
                     '-maes -march=native  -march=native',
 'PY_CORE_CFLAGS': '-Wsign-compare -fno-common -dynamic '
                   '-DDYNAMIC_ANNOTATIONS_ENABLED=1 -g -Ofast -Wall '
                   '-Wstrict-prototypes  -fomit-frame-pointer -funroll-loops  '
                   '-ffast-math -Ofast -fno-signed-zeros -ffp-contract=fast '
                   '-mmmx -msse -flto -maes -march=native  -march=native '
                   '-fomit-frame-pointer -funroll-loops  -ffast-math -Ofast '
                   '-fno-signed-zeros -ffp-contract=fast -mmmx -msse -flto '
                   '-maes -march=native  -march=native -I. -I./Include  '
 ...
 'PY_CPPFLAGS': '-I. -I./Include  -I/usr/local/opt/lapack/include '
                ...
                '-I/usr/local/opt/openssl@1.1/include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/usr/local/opt/lapack/lib -L/usr/local/opt/openblas/lib '
               '-L/usr/local/opt/llvm/lib -L/usr/local/opt/sqlite/lib '
               '-L/usr/local/opt/readline/lib -L/usr/local/opt/openssl@1.1/lib',
 'Py_DEBUG': 1,
 'Py_ENABLE_SHARED': 0,
 ...
 'SCRIPTDIR': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_FRAMEWORK_PATH=/Users/dojo/work/zspecial/python3.62mac '
               './python.exe',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_FRAMEWORK_PATH=/Users/dojo/work/zspecial/python3.62mac '
 ...
 'datarootdir': '/usr/local/Cellar/python3/3.6.2_1/share',
 'exec_prefix': '/usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework/Versions/3.6',
