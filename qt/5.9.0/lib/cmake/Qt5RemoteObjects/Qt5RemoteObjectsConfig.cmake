...
set(Qt5RemoteObjects_VERSION_STRING ..)
...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    set(Qt5RemoteObjects_PRIVATE_INCLUDE_DIRS
        "${_qt5RemoteObjects_install_prefix}/lib/QtRemoteObjects.framework/Versions/5/Headers/5.9.0/"
        "${_qt5RemoteObjects_install_prefix}/lib/QtRemoteObjects.framework/Versions/5/Headers/5.9.0/QtRemoteObjects"
    )
    ...
    foreach(_module_dep ${_Qt5RemoteObjects_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.0 ${_Qt5RemoteObjects_FIND_VERSION_EXACT}
