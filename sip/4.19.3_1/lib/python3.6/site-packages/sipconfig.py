...
_pkg_config = {
    ...
    'sip_config_args':    '--deployment-target=10.13 --destdir=/usr/local/Cellar/sip/4.19.3_1/lib/python3.6/site-packages --bindir=/usr/local/Cellar/sip/4.19.3_1/bin --incdir=/usr/local/Cellar/sip/4.19.3_1/include --sipdir=/usr/local/share/sip',
