...
# build directory.
TK_BUILD_LIB_SPEC='-L/private/tmp/tcl-tk--tk-20170816-36710-t0d4if/tk8.6.7/unix -ltk8.6'
...
# compiled.
TK_SRC_DIR='/private/tmp/tcl-tk--tk-20170816-36710-t0d4if/tk8.6.7'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/private/tmp/tcl-tk--tk-20170816-36710-t0d4if/tk8.6.7/unix -ltkstub8.6'
...
TK_BUILD_STUB_LIB_PATH='/private/tmp/tcl-tk--tk-20170816-36710-t0d4if/tk8.6.7/unix/libtkstub8.6.a'
